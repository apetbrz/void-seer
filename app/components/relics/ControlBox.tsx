...
function ControlBox(props: { settings: any, togglePane: Function, toggleMission: Function }) {
    ...
    return (
        <div className="mt-4 mb-4 grid">
            <button className="p-1 mx-auto" onClick={toggleActive}>
            ...
            <div id="controls" className={"grid overflow-hidden" + (active ? " open" : "")}>
                ...
                <div className="min-h-0">
                    <div className="w-auto flex flex-col mt-8 space-y-2 min-h-0 shadow-inner shadow-stone-300 dark:shadow-stone-950 bg-stone-200 dark:bg-stone-900">
